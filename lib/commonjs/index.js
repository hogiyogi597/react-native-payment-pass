...
const addPaymentPass = (cardHolderName, lastFour, paymentNetwork, paymentReferenceId, successCallback, errorCallback) => {
  PaymentPassModule.addPaymentPass(cardHolderName, lastFour, paymentNetwork, paymentReferenceId, successCallback, errorCallback ? errorCallback : noop);
};
